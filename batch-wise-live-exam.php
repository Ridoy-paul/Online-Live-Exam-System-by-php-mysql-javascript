    ...
    <div class="container">
        ...
        <div class="row" style="padding-bottom: 50px;">
            <?php
                            ...
                            $query = query("SELECT * FROM `exam` WHERE action='SHOW' AND examStatus='Temporary' AND courseID='$batchID' ORDER BY id DESC");
                                confirm($query);
                                            ...
                                            ?>
                                                <div class="col-sm-4 col-xl-4">
                                                    <div class="single_feature">
                                                        <div id="ridoyPaul" class="single_feature_part">
