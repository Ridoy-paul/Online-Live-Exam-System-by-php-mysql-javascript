		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="media/marchflogo.png" alt="IMG">
				</div>
				<form class="login100-form validate-form">
				    ...
				    <div class="row">
                        <div class="col-md-12">
                                <center>
                                    <h3 id="welcomeTo" style="font-size: 20px;"></b></h3>
                                    <div id="topImg">
                                    <img style="width: 250px;" src="media/er-1.png" alt="IMG">
                                        </div>
                                </center>
                        </div>
                    </div>
					...
					<div class="container-login100-form-btn">
						<button type="button" class="login100-form-btn btn btn-success" data-toggle="modal" data-target="#exampleModal">Admin Login</button>
					</div>
					<!--<div class="container-login100-form-btn">-->
					<!--	<button type="button" class="login100-form-btn btn btn-success" data-toggle="modal" data-target="#exampleModal1">Student Login</button>-->
					<!--</div>-->
					<div class="container-login100-form-btn">
					...
					<div class="row">
                        <div class="col-md-12">
                                <!--<center id="footerImg">-->
                                <!--    <img style="width: 150px;" src="media/er-1.png" alt="IMG">-->
                                <!--</center>-->
                        </div>
                    </div>
      ...
      <div class="modal-body">
        <form action="" method="POST">
                <div class="input-group mb-3">
                    <input type="text" name="username" class="form-control" placeholder="gmail or username">
...
<!--    <div class="modal-content">-->
<!--      <div class="modal-header">-->
<!--        <h5 class="modal-title" id="exampleModalLabel">Login Student</h5>-->
<!--        <button type="button" class="close" data-dismiss="modal" aria-label="Close">-->
<!--          <span aria-hidden="true">&times;</span>-->
<!--        </button>-->
<!--      </div>-->
...
<!--                    <div class="col-12">-->
<!--                        <button href="index.php" name="std_login" type="submit" class="btn btn-primary btn-block">Student Login</button>-->
<!--                    </div>-->
                    <!-- /.col -->
<!--                </div>-->
<!--            </form>-->
